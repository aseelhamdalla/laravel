...
<img class="rounded img-fluid" src="{{asset('public_theme/images/about.jpg')}}" alt="Card image cap">
</div>
...
<img class="img-fluid mb-4" src="{{asset('public_theme/images/user/s1.png')}}" alt="">
...
<div class="col-lg-4 col-md-4">
<div class="agents-card text-center">
<img class="img-fluid mb-4" src="{{asset('public_theme/images/user/s2.png')}}" alt="">
<p class="mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.</p>
...
<div class="col-lg-4 col-md-4">
<div class="agents-card text-center">
<img class="img-fluid mb-4" src="{{asset('public_theme/images/user/s3.png')}}" alt="">
<p class="mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.</p>
